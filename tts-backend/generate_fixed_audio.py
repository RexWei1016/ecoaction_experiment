...
SCRIPTS: dict[str, str] = {
    ...
    "06_action_none.wav": "我可以理解，在生活中，突然要改變原有的習慣並不容易。況且要付出額外的心力或時間來準備環保杯、環保提袋這些事情確實會複雜一點。但是我相信你也有那分心意想要讓地球更好，在接下來的幾天，如果你不介意，我想邀請你在生活中也可以嘗試看看，雖然不會立刻有效，但我覺得這樣的心意遲早有一天會對我們的地球帶來一些改變",
